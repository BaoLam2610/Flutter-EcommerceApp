...
const String text_login = 'Login';
const String text_register = 'Register';
const String text_sign_in = 'Sign In';
...
const String text_password_hint = 'Enter your password';
const String text_confirm_password = 'Confirm Password';
...
const String text_full_name_hint = 'Enter your full name';
const String text_phone_number = 'Phone Number';
const String text_phone_number_hint = 'Enter your phone number';
const String text_address = 'Address';
const String text_address_hint = 'Enter your address';
